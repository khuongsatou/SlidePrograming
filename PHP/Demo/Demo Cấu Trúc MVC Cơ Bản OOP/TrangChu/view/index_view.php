		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="nav nav-pills nav-stacked">
					<li class="active"><a href="index_view.php"><h4>Categories</h4></a></li>
					<?php
						$result =getCategories();
						while ($row= $result->fetch_assoc()) {
						   echo '<li><a href="?product_cat='.$row['cat_id'];
						   echo '&&page=1';
						   echo '&&price=3';
						   echo Get_product().'">'; 
						   echo $row['cat_title'];
				...
				<div class="nav nav-pills nav-stacked">
					...
					<?php
						$result =getBrands();
						while ($row= $result->fetch_assoc()) {
						   echo '<li><a href="?product_brand='.$row['brand_id'];
						   echo '&&price=3';
						   echo Get_product().'">'; 
...
<div class="foot">
	<footer>
		<p> Brought To You By <a href="https://code-projects.org/">Hồ Tấn Đạt</a></p>
	</footer>
</div>
<style>
	.foot {
